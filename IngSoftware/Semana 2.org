...
Concretar las tres lecturas sobre hipergrafos, revisión de clase Decorator y comienzo en la mejora de la clase hypergraph.py utilizando la clase Structure de Decorator. Por ultimo, definir diferentes elemtos del latex, como el resumen, los RNF y RF, las palabras clave y el diagrama de gantt. 
